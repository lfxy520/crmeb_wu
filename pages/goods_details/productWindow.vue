<template>
	<view :style="viewColor">
		<view class="product-window"
			...
			<view class="textpic acea-row row-between-wrapper">
				...
				<view class="text">
					...
					<view class="money">
						...
						<text class="stock" v-if='isShow'>{{$t('page.goodsDetail.inventory')}}: {{ attr.productSelect.product_stock }}</text>
					</view>
				</view>
			</view>
			<view class="rollTop">
			...
			<view class="joinBnt" v-if="attr.productSelect.product_stock" @click="goCat">{{$t('page.goodsDetail.confirm')}}</view>
