								...
								<view class="mer-name">
									...
									<view class="">
										<view class="mer-top">
											...
											<text v-else-if="item.is_trader" class="font-bg-red ml8">{{$t(`page.store.selfSupport`)}}</text>
										</view>
										<view class="mer-btn">
											<view class="">
												{{item.care_count<10000 ? item.care_count : (item.care_count/10000).toFixed(2)+'万'}}{{$t(`page.store.people`)}}
											</view>
