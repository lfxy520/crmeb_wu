<template>
	<view class="select_popup_container">
		<view class="popup_title">	
			<navigator v-if="mer_id" :url="`pages/product/addGoods/freightTemplate?mer_id=${mer_id}`" hover-class="none" class="manage_btn">{{$t('page.goodsAddcart.management')}}</navigator>		
...
export default {
	...
	created() {
		this.initData();
		this.tap.push({ value: '', label: $t('page.goodsDetail.choose1'), samelevel: this.assemblyList });
	},
	methods: {
		initData() {
