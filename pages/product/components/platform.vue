<template>
	<view class="select_popup_container platform">
		...
		<view class="popup_title">
			<view class="popup_title_msn">{{$t('page.product.selectit')}}{{$t('page.product.ptfenlei')}}</view>
		...
		<view class="tap_list">
			...
			<view class="tap_list_item" :class="{ 'border': selectIndex == -1 }" @click="pleaseSelect">{{$t('page.product.selectit')}}</view>
		</view>
