<template>
	<view class="container">
		<input-goods-detils @getProductContent="getProductContent" :title="$t('page.product.tip9')" :prodectContent="goodsDis" :maxLength="200"></input-goods-detils>
		<view class="handle"><view class="handle_button" @click="save">{{$t('page.product.save')}}</view></view>
