	...
	<view class="container">
		<view class="storeClassContent">
			...
			<view class="storeClassContent_tip">
				...
				<span>{{$t('page.product.tip1')}}</span>
			</view>
		</view>
		<view class="handle_bottom"><navigator :url="`/pages/product/storeClassification/addStoreClass?mer_id=${mer_id}`" class="handle_bottom_button">{{$t('page.product.addfenlei')}}</navigator></view>
	</view>
</template>
