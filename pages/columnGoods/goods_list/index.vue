		...
		<view class='productList'>
			<view class='search acea-row row-between-wrapper'>
				...
				<view class='input acea-row row-between-wrapper'><text class='iconfont icon-sousuo'></text>
					<input placeholder='' placeholder-class='placeholder' confirm-type='search' name="search" :value='where.keyword'
					 ...
					 @click="godDetail(item)">
						...
						<view class='text on'>
							...
							<view class='money on'>
								...
								<!-- <view class="ticket" v-if="item.issetCoupon">{{$t(`page.store.collar`)}}</view> -->
							</view>
							<view class="item_tags">
								...
								<text v-else-if="item.merchant.is_trader && item.product_type == 0" class="font-bg-red bt-color">{{$t(`page.store.selfSupport`)}}</text>
	...
	export default {
		...
		data() {
			return {
				...
				// 下拉菜单
				downMenu: [{
						title: this.$t(`page.goodsList.default`),
						key: 1,
					},
					{
