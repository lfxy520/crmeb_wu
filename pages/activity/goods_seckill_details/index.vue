					...
					<view id="past0">
						...
						<view class='wrapper'>
							...
							<view class='label acea-row row-between-wrapper'>
								...
								<view class="skeleton-rect">{{$t('page.goodsDetail.inventory')}}:{{storeInfo.stock}}{{storeInfo.unit_name}}</view>
								<view class="skeleton-rect">{{$t('page.goodsDetail.sales')}}:{{storeInfo.sales}}{{storeInfo.unit_name}}</view>
							</view>
						</view>
