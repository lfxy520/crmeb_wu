				...
				<view id="past0">
					...
					<view v-if="storeInfo.product_type == 4" class='wrapper'>
						...
						<view class='label acea-row row-between-wrapper'>
							...
							<view>{{$t('page.goodsDetail.inventory')}}:{{storeInfo.stock ? storeInfo.stock : 0}}</view>
					...
					<view v-if="storeInfo.product_type == 0 || storeInfo.product_type == 3 || storeInfo.product_type == 1" class='wrapper'>
						...
						<view class='introduce line2'>
							...
							<text v-else-if="storeInfo.merchant.is_trader" class="font-bg-red bg">{{$t(`page.store.selfSupport`)}}</text>{{storeInfo.store_name ? storeInfo.store_name : ''}}
							</view>
						<view class='label acea-row row-between-wrapper' style="padding-bottom: 10px">
							<view v-if="storeInfo.product_type != 3">{{$t('page.goodsDetail.oldPrice')}}:{{storeInfo.ot_price ? storeInfo.ot_price : ''}}</view>
							<view>{{$t('page.goodsDetail.inventory')}}:{{storeInfo.stock ? storeInfo.stock : 0}}{{storeInfo.unit_name ? storeInfo.unit_name : ''}}</view>
							<view>{{$t('page.goodsDetail.sales')}}:{{storeInfo.sales ? storeInfo.sales : 0}}{{storeInfo.unit_name ? storeInfo.unit_name : ''}}</view>
						</view>
					</view>
						...
						<view class="store-info">
							...
							<view class="info">
								<view class="name">{{storeInfo.merchant.mer_name ? storeInfo.merchant.mer_name : ''}}
									...
									<text v-else-if="storeInfo.merchant.is_trader" class="font-bg-red ml8">{{$t(`page.store.selfSupport`)}}</text>
								</view>
