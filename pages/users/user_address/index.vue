			...
			<view class='addAddress'>
				<view class='list'>
					<view class='item acea-row row-between-wrapper'>
						...
						<input type='text' :placeholder='$t(`page.users.userAddress.place`)+$t(`page.users.userAddress.name`)' name='real_name' :value="userAddress.real_name" placeholder-class='placeholder'></input>
					</view>
					<view class='item acea-row row-between-wrapper'>
						<view class='name'>{{$t(`page.users.userAddress.phone`)}}</view>
						<input type='text' :placeholder='$t(`page.users.userAddress.place`)+$t(`page.users.userAddress.phone`)' name="phone" :value='userAddress.phone' placeholder-class='placeholder'></input>
					</view>
					<!--<view class='item acea-row row-between-wrapper'>
					...
					<view class='item acea-row row-between-wrapper'>
						...
						<input type='text' class="location-input" :placeholder='$t(`page.users.userAddress.place`)+$t(`page.users.userAddress.address`)' name='detail' placeholder-class='placeholder' v-model="userAddress.detail"></input>
				...
				<view class='default acea-row row-middle'>
					<checkbox-group @change='ChangeIsDefault'>
						<checkbox :checked="userAddress.is_default ? true : false" />{{$t(`page.users.userAddress.default`)}}</checkbox-group>
				</view>

				<button class='keepBnt' form-type="submit">{{$t(`page.users.userAddress.save`)}}</button>
				<!-- #ifdef MP -->
		...
		methods: {
			...
			formSubmit: function(e) {
				...
				if (!value.real_name) return that.$util.Tips({
					title: this.$t(`page.users.userAddress.place`)+this.$t(`page.users.userAddress.name`)
				});
				if (!value.phone) return that.$util.Tips({
					title: this.$t(`page.users.userAddress.place`)+this.$t(`page.users.userAddress.phone`)
				});
				if (!value.detail) return that.$util.Tips({
					title: this.$t(`page.users.userAddress.place`)+this.$t(`page.users.userAddress.address`)
				});
