	...
	<view :style="viewColor">
		<view class='evaluate-list'>
			<view class='generalComment acea-row row-between-wrapper'>
				...
				<view><text class='t-color'>{{replyData.rate}}</text>{{$t(`page.users.goodsCommentList.good`)}}</view>
			</view>
			<view class='nav acea-row row-middle' v-if="replyData.stat">
				<view class='item' :class='type=="count" ? "b-color":""' @click='changeType("count")'>{{$t(`page.users.goodsCommentList.all`)}}({{replyData.stat.count}})</view>
				<view class='item' :class='type=="best" ? "b-color":""' @click='changeType("best")'>{{$t(`page.users.goodsCommentList.goodScore`)}}({{replyData.stat.best}})</view>
				<view class='item' :class='type=="middle" ? "b-color":""' @click='changeType("middle")'>{{$t(`page.users.goodsCommentList.general`)}}({{replyData.stat.middle}})</view>
				<view class='item' :class='type=="negative" ? "b-color":""' @click='changeType("negative")'>{{$t(`page.users.goodsCommentList.bad`)}}({{replyData.stat.negative}})</view>
			</view>
