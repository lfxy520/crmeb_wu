							...
							<view class="item acea-row row-right">
								<view class="picTxt acea-row row-between-wrapper" @click="godDetail(item)">
									...
									<view class="text">
										...
										<text v-else-if="item.merchant && item.merchant.is_trader" class="font-bg-red mt8  b-color">{{$t(`page.store.selfSupport`)}}</text>
				...
				<view class="item acea-row row-between-wrapper" v-for="(item, index) in distribution" :key='index' @click="godDetail(item)">
					...
					<view class="text">
						<view class="name line2">
							...
							<text v-else-if="item.merchant && item.merchant.is_trader" class="font-bg-red ml8 b-color">{{$t(`page.store.selfSupport`)}}</text>
							{{item.store_name}}
						</view>
