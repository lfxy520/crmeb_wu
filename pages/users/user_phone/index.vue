	...
	<view :style="viewColor">
		<form report-submit='true'>
			<view class="ChangePassword">
				<view class="list">
					<view class="item">
						<input type='number' :placeholder='$t(`message.settled.emptyPhone`)' placeholder-class='placeholder' v-model="phone"></input>
					</view>
					<view class="item acea-row row-between-wrapper">
						<input type='number' :placeholder='$t(`message.settled.emptyCaptche`)' placeholder-class='placeholder' class="codeIput" v-model="captcha"></input>
						<button class="code" :class="disabled === true ? 'on' : ''" :disabled='disabled' @click="code">
							{{ text }}
						</button>
					</view>
				</view>
				<button form-type="submit" @click="editPwd" class="confirmBnt">{{$t(`page.users.login.submit`)}}</button>
				<!-- #ifdef MP -->
		...
		methods: {
			...
			editPwd: function() {
				...
				if (!that.captcha) return that.$util.Tips({
					title: this.$t(`message.settled.emptyCaptche`)
				});
				bindingPhone({
					phone: that.phone,
