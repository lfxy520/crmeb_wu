		...
		<view class="oper-wrapper" :style="{display: sD, top:tp}">
			<view class="oper">
				<view class="btn-wrapper" v-if="sO">
					<view @click="fSelect" hover-class="hover" :style="{width: bW}"><text>{{$t('page.product.reselect')}}</text></view>
					<view @click="fClose" hover-class="hover" :style="{width: bW}"><text>{{$t('page.product.close')}}</text></view>
					<view @click="fRotate" hover-class="hover" :style="{width: bW, display: bD}"><text>旋转</text></view>
					<view @click="fPreview" hover-class="hover" :style="{width: bW}"><text>{{$t('page.product.review')}}</text></view>
					<view @click="fUpload" hover-class="hover" :style="{width: bW}"><text>{{$t('page.product.upload')}}</text></view>
				</view>
				<view class="clr-wrapper" v-else>
					...
					<view @click="fPrvUpload" hover-class="hover" :style="{width: bW}"><text>{{$t('page.product.upload')}}</text></view>
				</view>
			</view>
		</view>
	</view>
