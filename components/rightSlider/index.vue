		...
		<view class="control-wrapper animated" :class="showBox?'slideInRight':''">			
			<view class="content-box">
				...
				<view class="brand-wrapper">
					...
					<view class="btns" v-if="!isShow && list.length>9" @click="isShow = true">{{$t(`page.goodsSearch.open`)}}<text class="iconfont icon-xiangxia"></text></view>
					<view class="btns" v-if="isShow && list.length>9"  @click="isShow = false">{{$t(`page.goodsSearch.up`)}}<text class="iconfont icon-xiangshang"></text></view>
				</view>
				...
				<view class="brand-wrapper">
					...
					<view class="btns" v-if="!isShow && merCate.length>9" @click="isShow = true">{{$t(`page.goodsSearch.open`)}}<text class="iconfont icon-xiangxia"></text></view>
					<!-- <view class="btns" v-if="isShow && merCate.length>9"  @click="isShow = false">{{$t(`page.goodsSearch.up`)}}<text class="iconfont icon-xiangshang"></text></view> -->
				</view>
				<view class="foot-btn">
					<view class="btn-item" @click="reset">重置</view>
					<view class="btn-item confirm" @click="confirm">{{$t('page.goodsDetail.confirm')}}</view>
				</view>
			</view>
		</view>
