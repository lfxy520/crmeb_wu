	...
	export default{
		...
		data(){
			return {
				...
				list:[],
				storeTypeList: [
					{name: this.$t('page.users.goodsCommentList.all'), value: '',check: true},
					{name: this.$t('page.store.selfSupport'), value: 'trader',check: false},
				],
				activeList:[],
				showBox:false
			}
		...
		methods:{	
			...
			bindChenckType(item,index){
				...
				this.storeTypeList = [
					{name: this.$t('page.users.goodsCommentList.all'), value: '',check: false},
					{name: this.$t('page.store.selfSupport'), value: 'trader',check: false},
				]
